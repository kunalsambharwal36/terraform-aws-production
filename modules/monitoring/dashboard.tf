  ...
  dashboard_body = jsonencode({
    widgets = [
...

      {
        ...
        properties={
          metrics=[["AWS/ApplicationELB","UnHealthyHostCount","TargetGroup",var.target_group_arn_suffix,"LoadBalancer",var.alb_arn_suffix]]
          period=60
          stat="Average"
          region=var.region
...

      {
        ...
        properties={
          metrics=[["AWS/ApplicationELB","HTTPCode_Target_5XX_Count","TargetGroup",var.target_group_arn_suffix,"LoadBalancer",var.alb_arn_suffix]]
          period=60
          stat="Sum"
          region=var.region
...

      {
        ...
        properties={
          metrics=[["AWS/AutoScaling","GroupDesiredCapacity","AutoScalingGroupName",var.asg_name]]
          period=60
          stat="Average"
          region=var.region
...

      {
        ...
        properties={
          metrics=[["CloudShop","mem_used_percent"]]
          period=60
          stat="Average"
          region=var.region
...

      {
        ...
        properties={
          metrics=[["CloudShop","disk_used_percent","path","/","device","nvme0n1p1","fstype","xfs"]]
          period=60
          stat="Average"
          region=var.region
...

      {
        ...
        properties={
          metrics=[["CloudShop","swap_used_percent"]]
          period=60
          stat="Average"
          region=var.region
          title="Swap Usage %"
...

      {
        ...
        properties={
          metrics=[["AWS/RDS","ReadIOPS","DBInstanceIdentifier",var.db_identifier]]
          period=60
          stat="Average"
          region=var.region
          title="RDS Read IOPS"
...

      {
        ...
        properties={
          metrics=[["AWS/RDS","WriteIOPS","DBInstanceIdentifier",var.db_identifier]]
          period=60
          stat="Average"
          region=var.region
